...
void averageprog_1( char* host, int argc, char *argv[] )
{
   ...
   char 	*endptr;
   char ascend_flag[1000] = "-a";
   char descend_flag[1000] = "-d";
   double answer[1000];
   char *str = (char *) malloc(12*sizeof(char));
   //str = (char *) malloc(150);
   input_data  average_1_arg; /* input_data rpc struct */

   average_1_arg.input_data.input_data_val = (char*) malloc(500*sizeof(char));
  ...
  printf("Unordered:  ");
   for( i = 1; i <= (argc - 2); i++ )
   {
	...
	if (i == 1)
	{
		if (strcmp(descend_flag, argv[2]) == 0)
		{
		//printf("DESCEND FLAG USED.\n");
		*dp = 101;
		dp++;
		}
		
	if (strcmp(ascend_flag, argv[2]) == 0)
	{
		//printf("ASCEND FLAG USED.\n");
		*dp = 100;
		dp++;
	}	
	}
    ...
    */
   //strcpy(str,average_1( &average_1_arg, clnt ));
   str = average_1( &average_1_arg, clnt );
   printf("\n\nOrdered:    ");
   printf("%s \n",str);
}
